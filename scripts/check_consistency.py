...
POLICY_ANCHORS: dict[str, tuple[str, ...]] = {
    "SKILL.md": (
        ...
        "For a durable multi-stage solution, maintain one solution control surface",
    ...
    "00-progress-router.md": (
        ...
        "A shallow finite batch ledger and aggregate progress record are required for a durable staged solution",
    ...
    "00-solution-framing.md": (
        ...
        "Treat `99-进度.md` as the single aggregate progress authority",
    ...
    "99-status-and-evidence.md": (
        ...
        "Use counts as the default total-progress record",
